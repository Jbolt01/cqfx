...
public final class Heartbeat extends Table {
  ...
  public long nonce() { int o = __offset(4); return o != 0 ? bb.getLong(o + bb_pos) : 0L; }
  ...
  public static void addNonce(FlatBufferBuilder builder, long nonce) { builder.addLong(0, nonce, 0L); }
