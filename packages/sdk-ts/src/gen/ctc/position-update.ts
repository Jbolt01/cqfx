...
export class PositionUpdate implements flatbuffers.IUnpackableObject<PositionUpdateT> {
...
static getRootAsPositionUpdate(bb:flatbuffers.ByteBuffer, obj?:PositionUpdate):PositionUpdate {
  return (obj || new PositionUpdate()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPositionUpdate(bb:flatbuffers.ByteBuffer, obj?:PositionUpdate):PositionUpdate {
...
static addRealizedPnlTicks(builder:flatbuffers.Builder, realizedPnlTicks:bigint) {
  builder.addFieldInt64(5, realizedPnlTicks, BigInt('0'));
}

static addUnrealizedPnlTicks(builder:flatbuffers.Builder, unrealizedPnlTicks:bigint) {
  builder.addFieldInt64(6, unrealizedPnlTicks, BigInt('0'));
}

static addHeadroomLongLots(builder:flatbuffers.Builder, headroomLongLots:bigint) {
  builder.addFieldInt64(7, headroomLongLots, BigInt('0'));
}

static addHeadroomShortLots(builder:flatbuffers.Builder, headroomShortLots:bigint) {
...
static createPositionUpdate(builder:flatbuffers.Builder, teamId:number, instrumentId:number, posLots:bigint, openBuyLots:bigint, openSellLots:bigint, realizedPnlTicks:bigint, unrealizedPnlTicks:bigint, headroomLongLots:bigint, headroomShortLots:bigint, tsNanos:bigint):flatbuffers.Offset {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return PositionUpdate.createPositionUpdate(builder,
    this.teamId,
    this.instrumentId,
    this.posLots,
    this.openBuyLots,
