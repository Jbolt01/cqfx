...
export class EtfComponent implements flatbuffers.IUnpackableObject<EtfComponentT> {
...
static getRootAsEtfComponent(bb:flatbuffers.ByteBuffer, obj?:EtfComponent):EtfComponent {
  return (obj || new EtfComponent()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEtfComponent(bb:flatbuffers.ByteBuffer, obj?:EtfComponent):EtfComponent {
...
static addComponentInstrumentId(builder:flatbuffers.Builder, componentInstrumentId:number) {
...
static createEtfComponent(builder:flatbuffers.Builder, etfInstrumentId:number, componentInstrumentId:number, weightNum:number, weightDen:number):flatbuffers.Offset {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return EtfComponent.createEtfComponent(builder,
    this.etfInstrumentId,
    this.componentInstrumentId,
    this.weightNum,
    this.weightDen
