...
export class OrderReplace
	implements flatbuffers.IUnpackableObject<OrderReplaceT>
{
	...
	static getRootAsOrderReplace(
		bb: flatbuffers.ByteBuffer,
		obj?: OrderReplace,
	): OrderReplace {
		return (obj || new OrderReplace()).__init(
			bb.readInt32(bb.position()) + bb.position(),
			bb,
		);
	}

	static getSizePrefixedRootAsOrderReplace(
		bb: flatbuffers.ByteBuffer,
		obj?: OrderReplace,
	): OrderReplace {
...
export class OrderReplaceT implements flatbuffers.IGeneratedObject {
	...
	pack(builder: flatbuffers.Builder): flatbuffers.Offset {
		return OrderReplace.createOrderReplace(
			builder,
			this.origClOrdId,
			this.newClOrdId,
			this.instrumentId,
