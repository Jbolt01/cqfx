...
static createUnsubscribe(builder:flatbuffers.Builder, instrumentsOffset:flatbuffers.Offset, teamId:number):flatbuffers.Offset {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const instruments = Unsubscribe.createInstrumentsVector(builder, this.instruments);
