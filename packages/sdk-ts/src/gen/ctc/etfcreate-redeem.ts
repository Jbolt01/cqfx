...
export class ETFCreateRedeem implements flatbuffers.IUnpackableObject<ETFCreateRedeemT> {
...
static getRootAsETFCreateRedeem(bb:flatbuffers.ByteBuffer, obj?:ETFCreateRedeem):ETFCreateRedeem {
  return (obj || new ETFCreateRedeem()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsETFCreateRedeem(bb:flatbuffers.ByteBuffer, obj?:ETFCreateRedeem):ETFCreateRedeem {
...
static createETFCreateRedeem(builder:flatbuffers.Builder, requestId:bigint, etfInstrumentId:number, lots:bigint, userId:number, teamId:number):flatbuffers.Offset {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return ETFCreateRedeem.createETFCreateRedeem(builder,
    this.requestId,
    this.etfInstrumentId,
    this.lots,
    this.userId,
