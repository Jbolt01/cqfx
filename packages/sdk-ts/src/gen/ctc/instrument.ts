...
static getRootAsInstrument(bb:flatbuffers.ByteBuffer, obj?:Instrument):Instrument {
  return (obj || new Instrument()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsInstrument(bb:flatbuffers.ByteBuffer, obj?:Instrument):Instrument {
...
static createInstrument(builder:flatbuffers.Builder, id:number, symbolOffset:flatbuffers.Offset, type:InstrType, currencyOffset:flatbuffers.Offset, tickSizeNanos:number, tickSizeTicks:number, lotSizeLots:number, meta:bigint):flatbuffers.Offset {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Instrument.createInstrument(builder,
    this.id,
    symbol,
    this.type,
    currency,
