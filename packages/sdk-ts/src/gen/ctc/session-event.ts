...
export class SessionEvent implements flatbuffers.IUnpackableObject<SessionEventT> {
...
static getRootAsSessionEvent(bb:flatbuffers.ByteBuffer, obj?:SessionEvent):SessionEvent {
  return (obj || new SessionEvent()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSessionEvent(bb:flatbuffers.ByteBuffer, obj?:SessionEvent):SessionEvent {
...
static createSessionEvent(builder:flatbuffers.Builder, sessionId:number, roundNo:number, dayNo:number, stateOffset:flatbuffers.Offset, tsNanos:bigint):flatbuffers.Offset {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SessionEvent.createSessionEvent(builder,
    this.sessionId,
    this.roundNo,
    this.dayNo,
    state,
