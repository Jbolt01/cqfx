...
static createTrade(builder:flatbuffers.Builder, instrumentId:number, tradeId:bigint, pxTicks:number, lots:bigint, aggressor:Side, tsNanos:bigint, matchId:bigint):flatbuffers.Offset {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return Trade.createTrade(builder,
    this.instrumentId,
    this.tradeId,
    this.pxTicks,
    this.lots,
