...
export class PriceLevelDelta implements flatbuffers.IUnpackableObject<PriceLevelDeltaT> {
...
static getRootAsPriceLevelDelta(bb:flatbuffers.ByteBuffer, obj?:PriceLevelDelta):PriceLevelDelta {
  return (obj || new PriceLevelDelta()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPriceLevelDelta(bb:flatbuffers.ByteBuffer, obj?:PriceLevelDelta):PriceLevelDelta {
...
static createPriceLevelDelta(builder:flatbuffers.Builder, side:Side, pxTicks:number, deltaLots:bigint):flatbuffers.Offset {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return PriceLevelDelta.createPriceLevelDelta(builder,
    this.side,
    this.pxTicks,
    this.deltaLots
  );
