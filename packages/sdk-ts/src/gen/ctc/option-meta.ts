...
export class OptionMeta implements flatbuffers.IUnpackableObject<OptionMetaT> {
	...
	static getRootAsOptionMeta(
		bb: flatbuffers.ByteBuffer,
		obj?: OptionMeta,
	): OptionMeta {
		return (obj || new OptionMeta()).__init(
			bb.readInt32(bb.position()) + bb.position(),
			bb,
		);
	}

	static getSizePrefixedRootAsOptionMeta(
		bb: flatbuffers.ByteBuffer,
		obj?: OptionMeta,
	): OptionMeta {
	...
	static addUnderlyingInstrumentId(
...
export class OptionMetaT implements flatbuffers.IGeneratedObject {
	...
	pack(builder: flatbuffers.Builder): flatbuffers.Offset {
		return OptionMeta.createOptionMeta(
			builder,
			this.instrumentId,
			this.underlyingInstrumentId,
			this.strikeTicks,
