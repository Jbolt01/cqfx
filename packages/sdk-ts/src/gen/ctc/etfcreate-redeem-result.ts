...
export class ETFCreateRedeemResult implements flatbuffers.IUnpackableObject<ETFCreateRedeemResultT> {
...
static getRootAsETFCreateRedeemResult(bb:flatbuffers.ByteBuffer, obj?:ETFCreateRedeemResult):ETFCreateRedeemResult {
  return (obj || new ETFCreateRedeemResult()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsETFCreateRedeemResult(bb:flatbuffers.ByteBuffer, obj?:ETFCreateRedeemResult):ETFCreateRedeemResult {
...
legs(index: number, obj?:EtfLeg):EtfLeg|null {
  ...
  return offset ? (obj || new EtfLeg()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
static addEtfInstrumentId(builder:flatbuffers.Builder, etfInstrumentId:number) {
...
static endETFCreateRedeemResult(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static createETFCreateRedeemResult(builder:flatbuffers.Builder, requestId:bigint, etfInstrumentId:number, lots:bigint, legsOffset:flatbuffers.Offset, success:boolean, rejectCode:RejectCode, textOffset:flatbuffers.Offset, tsNanos:bigint):flatbuffers.Offset {
...
unpack(): ETFCreateRedeemResultT {
  return new ETFCreateRedeemResultT(
    ...
    this.lots(),
    this.bb!.createObjList<EtfLeg, EtfLegT>(this.legs.bind(this), this.legsLength()),
    this.success(),
    this.rejectCode(),
    this.text(),
    this.tsNanos()
...
unpackTo(_o: ETFCreateRedeemResultT): void {
  ...
  _o.lots = this.lots();
  _o.legs = this.bb!.createObjList<EtfLeg, EtfLegT>(this.legs.bind(this), this.legsLength());
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const legs = ETFCreateRedeemResult.createLegsVector(builder, builder.createObjectOffsetList(this.legs));
  const text = (this.text !== null ? builder.createString(this.text!) : 0);

  return ETFCreateRedeemResult.createETFCreateRedeemResult(builder,
    this.requestId,
    this.etfInstrumentId,
    this.lots,
    legs,
