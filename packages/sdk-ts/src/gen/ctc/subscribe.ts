...
static createInstrumentsVector(builder:flatbuffers.Builder, data:number[]|Uint32Array):flatbuffers.Offset;
/**
 * @deprecated This Uint8Array overload will be removed in the future.
 */
static createInstrumentsVector(builder:flatbuffers.Builder, data:number[]|Uint8Array):flatbuffers.Offset;
static createInstrumentsVector(builder:flatbuffers.Builder, data:number[]|Uint32Array|Uint8Array):flatbuffers.Offset {
...
static createSubscribe(builder:flatbuffers.Builder, instrumentsOffset:flatbuffers.Offset, bookDepth:number, trades:boolean, positions:boolean, teamId:number):flatbuffers.Offset {
...
unpack(): SubscribeT {
  return new SubscribeT(
    this.bb!.createScalarList<number>(this.instruments.bind(this), this.instrumentsLength()),
    this.bookDepth(),
    this.trades(),
    this.positions(),
    this.teamId()
...
unpackTo(_o: SubscribeT): void {
  _o.instruments = this.bb!.createScalarList<number>(this.instruments.bind(this), this.instrumentsLength());
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const instruments = Subscribe.createInstrumentsVector(builder, this.instruments);
