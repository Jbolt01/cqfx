...
export class CancelAll implements flatbuffers.IUnpackableObject<CancelAllT> {
	...
	static getRootAsCancelAll(
		bb: flatbuffers.ByteBuffer,
		obj?: CancelAll,
	): CancelAll {
		return (obj || new CancelAll()).__init(
			bb.readInt32(bb.position()) + bb.position(),
			bb,
		);
	}

	static getSizePrefixedRootAsCancelAll(
		bb: flatbuffers.ByteBuffer,
		obj?: CancelAll,
	): CancelAll {
	...
	unpack(): CancelAllT {
		return new CancelAllT(this.scope(), this.userId(), this.teamId());
	}
...
export class CancelAllT implements flatbuffers.IGeneratedObject {
	...
	pack(builder: flatbuffers.Builder): flatbuffers.Offset {
		...
		return CancelAll.createCancelAll(builder, scope, this.userId, this.teamId);
	}
}
